  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <!-- <div
        ...
        :key="address.id"
      >
        <span class="username" :class="{ selected: address.isDefault == 1 }">**</span>
...
export default {
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      //其余的六个参数
      let data = {
        consignee: 'admin', //最终收件人的名字
        consigneeTel: 'aima', //最终收件人的手机号
        deliveryAddress: '地球村', //收件人的地址
        paymentWay: 'ONLINE', //支付方式
        orderComment: '你好', //买家的留言信息
