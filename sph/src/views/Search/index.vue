      ...
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            ...
            <li
              class="with-x"
              v-show="this.searchParams.categoryName"
            ...
            <li
              class="with-x"
              v-show="this.searchParams.keyword"
              @click="removeKeyword"
            >
            ...
            <li
              class="with-x"
              v-show="this.searchParams.trademark"
              @click="removeBrand"
            >
                ...
                <li :class="{ active: isOne }" @click="changeOrder(1)">
                  <a
                    ...
                    <span
                      ...
                      v-show="isOne"
                      :class="{
                        'icon-zhixiangshang': isAsc,
                        'icon-zhixiangxia': isDesc,
                      }"
                    ></span>
                  </a>
                </li>
